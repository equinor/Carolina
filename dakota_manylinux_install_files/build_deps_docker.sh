...
export LD_LIBRARY_PATH="$INSTALL_DIR/lib:/usr/local/lib:$PYTHON_DEV_HEADERS_DIR:/tmp/INSTALL_DIR/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
...
cmake \
  ...
  .. &> "$WORKSPACE/trace/dakota_bootstrap.log"
